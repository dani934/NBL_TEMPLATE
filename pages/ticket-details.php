...
<html lang="en" dir="ltr">
	...
	<body class="ltr app sidebar-mini ticket-page">
								...
								<div class="col-12">
									<div class="card p-0">
										...
										<div class="card-footer ticket-details-footer p-0">
											...
											<div class="media ticket-reply">
												<div class="me-3">
													<a href="profile.php"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/13.jpg"> </a>
												</div>
												<div class="media-body">
													<nav class="nav float-end">
														<div class="dropdown">
		...
		<!-- TICKET DETAILS JS -->
		<script src="../assets/js/ticket-details.js"></script>
