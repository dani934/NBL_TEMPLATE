												...
												<table id="user-datatable" class="table table-bordered">
													...
													<tbody>
														...
														<tr>
															<td class="text-center">
																<div class="avatar avatar-md rounded-circle">
																	<img alt="avatar" class="rounded-circle" src="../assets/images/faces/9.jpg">
																</div>
															</td>
															<td>
														...
														<tr>
															<td class="text-center">
																<div class="avatar avatar-md rounded-circle">
																	<img alt="avatar" class="rounded-circle" src="../assets/images/faces/13.jpg">
																</div>
															</td>
															<td>
														...
														<tr>
															<td class="text-center">
																<div class="avatar avatar-md rounded-circle">
																	<img alt="avatar" class="rounded-circle" src="../assets/images/faces/14.jpg">
																</div>
															</td>
															<td>
														...
														<tr>
															<td class="text-center">
																<div class="avatar avatar-md rounded-circle">
																	<img alt="avatar" class="rounded-circle" src="../assets/images/faces/15.jpg">
																</div>
															</td>
															<td>
														...
														<tr>
															<td class="text-center">
																<div class="avatar avatar-md rounded-circle">
																	<img alt="avatar" class="rounded-circle" src="../assets/images/faces/16.jpg">
																</div>
															</td>
															<td>
														...
														<tr>
															<td class="text-center">
																<div class="avatar avatar-md rounded-circle">
																	<img alt="avatar" class="rounded-circle" src="../assets/images/faces/17.jpg">
																</div>
															</td>
															<td>
