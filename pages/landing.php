...
<html lang="en">
	<head>
		<?php include '../layouts/landing/styles.php'; ?>
	</head>
	...
	<body class="ltr app horizontal landing-page">
		...
		<div class="page">
			<div class="page-main">
				...
				<!-- LANDING-HEADER -->
				<?php include '../layouts/landing/header.php'; ?>
				<!-- /LANDING-HEADER -->

				<!-- LANDING-SIDEBAR-->
				<?php include '../layouts/landing/sidebar.php'; ?>
				<!--/LANDING-SIDEBAR-->
				...
				<div class="hor-content main-content mt-0">
					<div class="side-app">
						...
						<div class="main-container">
												...
												<div class="statistics-info">
													<div class="col-xl-12 col-12">
														<div class="row">
															...
															<div class="col-xl-6 col-md-12 col-sm-12">
																<div class="">
																	<form class="form-horizontal  m-t-20 row" action="index.php">
																		<div class="col-xl-6">
							...
							<!-- FOOTER -->
							<?php include '../layouts/landing/footer.php'; ?>
							<!-- FOOTER END -->
		...
		<?php include '../layouts/landing/scripts.php'; ?>
