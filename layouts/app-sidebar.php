								...
								<ul class="side-menu">
									...
									<li class="slide">
										...
										<ul class="slide-menu">
											...
											<li><a href="form-layouts.php" class="slide-item">Form Layouts</a></li>
											...
											<li><a href="wysiwyag.php" class="slide-item">Form Editors</a></li>
											<li><a href="form-editable.php" class="slide-item">Form Editable</a></li>
									...
									<li class="slide">
										...
										<ul class="slide-menu">
											...
											<li><a href="table-editable.php" class="slide-item">Editable Tables</a></li>
										</ul>
									</li>
									<li class="slide">
										<a class="side-menu__item has-link" data-bs-toggle="slide" href="landing.php" target="_blank">
									...
									<li class="slide">
										...
										<ul class="slide-menu">
											...
											<li><a href="chart-chartjs.php" class="slide-item">Chart Js</a></li>
									...
									<li class="slide">
										...
										<ul class="slide-menu">
											...
											<li><a href="calendar2.php" class="slide-item">Calendar</a></li>
											...
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														...
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="cart.php">Cart</a></li>
													<li><a class="sub-slide-item" href="checkout.php">Checkout</a></li>
													<li><a class="sub-slide-item" href="products.php">Products</a></li>
													<li><a class="sub-slide-item" href="product-details.php">Product-Details</a></li>
													<li><a class="sub-slide-item" href="wishlist.php">Wishlist</a></li>
												</ul>
											</li>
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														...
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="file-manager.php">Files</a></li>
													<li><a class="sub-slide-item" href="file-manager-1.php">File Manager</a></li>
													<li><a class="sub-slide-item" href="file-manager-2.php">File Details</a></li>
												</ul>
											</li>
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														...
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="mail-inbox.php">Inbox</a></li>
													<li><a class="sub-slide-item" href="mail-compose.php">Compose Mail</a></li>
													<li><a class="sub-slide-item" href="mail-read.php">Read Mail</a></li>
													<li><a class="sub-slide-item" href="mail-settings.php">Mail Settings</a></li>
												</ul>
											</li>
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														...
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="invoice-list.php">Invoice List</a></li>
													<li><a class="sub-slide-item" href="invoice-details.php">Invoice Details</a></li>
													<li><a class="sub-slide-item" href="invoice-create.php">Create Invoice</a></li>
													<li><a class="sub-slide-item" href="invoice-timelog.php">Time Log Invoice</a></li>
													<li><a class="sub-slide-item" href="invoice-edit.php">Edit Invoice</a></li>
												</ul>
											</li>
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														...
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="projects.php">Projects</a></li>
													<li><a class="sub-slide-item" href="projects-list.php">Projects List</a></li>
													<li><a class="sub-slide-item" href="project-details.php">Project Details</a></li>
													<li><a class="sub-slide-item" href="project-new.php">Project New</a></li>
													<li><a class="sub-slide-item" href="project-edit.php">Edit Project</a></li>
												</ul>
											</li>
											<li><a href="ticket-details.php" class="slide-item"><span class="side-menu__label">Tickets</span></a></li>
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														class="sub-side-menu__label">Tasks</span><i
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="tasks-list.php">Task List</a></li>
													<li><a class="sub-slide-item" href="task-edit.php">Edit Task</a></li>
													<li><a class="sub-slide-item" href="task-create.php">Create Task</a></li>
												</ul>
											</li>
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														...
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="clients.php">Clients</a></li>
													<li><a class="sub-slide-item" href="client-create.php">Add Client</a></li>
												</ul>
											</li>
										</ul>
									</li>
									...
									<li class="slide">
										...
										<ul class="slide-menu">
											...
											<li><a href="avatar.php" class="slide-item">Avatar</a></li>
											...
											<li><a href="scroll.php" class="slide-item">Scroll</a></li>
									...
									<li class="slide">
										...
										<ul class="slide-menu">
											...
											<li><a href="carousel.php" class="slide-item">Carousel</a></li>
											<li><a href="cards.php" class="slide-item">Cards</a></li>
											<li><a href="counters.php" class="slide-item">Counters</a></li>
											<li><a href="modal.php" class="slide-item">Modals</a></li>
											...
											<li><a href="progress.php" class="slide-item">Progress Bars</a></li>

											<li><a href="footers.php" class="slide-item">Footers</a></li>
											<li><a href="users-list.php" class="slide-item">Users List</a></li>
										...
										<ul class="slide-menu">
											...
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														...
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="login.php">Sign In</a></li>
													<li><a class="sub-slide-item" href="register.php">Sign Up</a></li>
													<li><a class="sub-slide-item" href="forgot-password.php">Forgot Password</a></li>
													<li><a class="sub-slide-item" href="lockscreen.php">Lockscreen</a></li>
													<li><a class="sub-slide-item" href="construction.php">UnderConstruction</a></li>
												</ul>
											</li>
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														...
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="404.php">404 Error</a></li>
													<li><a class="sub-slide-item" href="500.php">500 Error</a></li>
													<li><a class="sub-slide-item" href="501.php">501 Error</a></li>
												</ul>
											</li>
											<li><a href="settings.php" class="slide-item">Settings</a></li>
											...
											<li><a href="switcher.php" class="slide-item">Switcher</a></li>
											<li><a href="terms.php" class="slide-item">Terms</a></li>
											<li><a href="faq.php" class="slide-item">Faq's</a></li>
											<li><a href="pricing.php" class="slide-item">Pricing</a></li>
											<li class="sub-slide">
												<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
														class="sub-side-menu__label">Blog</span><i
														class="sub-angle fa fa-angle-right"></i></a>
												<ul class="sub-slide-menu">
													<li><a class="sub-slide-item" href="blog.php">Blog</a></li>
													<li><a class="sub-slide-item" href="blog-details.php">Blog Details</a></li>
													<li><a class="sub-slide-item" href="blog-edit.php">Edit Post</a></li>
												</ul>
											</li>
										</ul>
									</li>
									<li class="slide">
										...
										<ul class="slide-menu">
											...
											<li><a href="background.php" class="slide-item">Background</a></li>
											<li><a href="border.php" class="slide-item">Border</a></li>
											<li><a href="display.php" class="slide-item">Display</a></li>
											<li><a href="flex.php" class="slide-item">Flex</a></li>
											<li><a href="height.php" class="slide-item">Height</a></li>
											<li><a href="margin.php" class="slide-item">Margin</a></li>
											<li><a href="padding.php" class="slide-item">Padding</a></li>
											<li><a href="position.php" class="slide-item">Position</a></li>
											<li><a href="width.php" class="slide-item">Width</a></li>
											<li><a href="opacity.php" class="slide-item">Opacity</a></li>
