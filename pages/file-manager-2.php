						...
						<div class="main-container container-fluid">
										...
										<div class="card-body p-3">
											<div class="breadcrumb-main">
												<nav aria-label="breadcrumb">
													...
													<li class="breadcrumb-item"><a href="file-manager.php">Home</a></li>
													<li class="breadcrumb-item"><a href="file-manager-1.php">File Manager</a></li>
							...
							<div class="row row-sm">
								<div class="col-xl-8 col-lg-8 col-md-12">
									<div class="card custom-card overflow-hidden">
										<div class="card-body">
											<a href="javascript:void(0)"><img src="../assets/images/photos/blogmain3.jpg" alt="img" class="cover-image br-7 w-100"></a>
										</div>
												...
												<div class="item">
													<div class="card">
														<div class="card custom-card overflow-hidden mb-0 ">
															<a href="file-manager-2.php"><img src="../assets/images/photos/fileimage4.jpg" class="w-100" alt="img"></a>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="card">
														<div class="card custom-card overflow-hidden mb-0 ">
															<a href="file-manager-2.php"><img src="../assets/images/photos/fileimage1.jpg" class="w-100" alt="img"></a>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="card">
														<div class="card custom-card overflow-hidden mb-0 ">
															<a href="file-manager-2.php"><img src="../assets/images/photos/fileimage2.jpg" class="w-100" alt="img"></a>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="card">
														<div class="card custom-card overflow-hidden mb-0 ">
															<a href="file-manager-2.php"><img src="../assets/images/photos/fileimage3.jpg" class="w-100" alt="img"></a>
														</div>
													</div>
												</div>
												<div class="item">
														...
														<div class="card m-0 p-0 border">
															...
															<div class="card-body pt-0 text-center">
																<div class="file-manger-icon">
																	<a href="file-manager-2.php">
																		<img src="../assets/images/files/folder.png" alt="img" class="br-7">
																	</a>
																</div>
													...
													<div class="col-xl-3 col-md-6 col-sm-6 my-1">
														<div class="card m-0 p-0 border">
															...
															<div class="card-body pt-0 text-center">
																<div class="file-manger-icon">
																	<a href="file-manager-2.php">
																		<img src="../assets/images/files/word.png" alt="img" class="br-7 img-link">
																	</a>
																</div>
													...
													<div class="col-xl-3 col-md-6 col-sm-6 my-1">
														<div class="card m-0 p-0 border">
															...
															<div class="card-body pt-0 text-center">
																<div class="file-manger-icon">
																	<a href="file-manager-2.php">
																		<img src="../assets/images/files/file.png" alt="img" class="br-7 img-link">
																	</a>
																</div>
