                                        ...
                                        <div class="main-content-app pt-0">
                                            <div class="main-content-left main-content-left-chat">
                                                <div class="card-body d-flex">
                                                    <div class="main-img-user online"><img alt="avatar" src="../assets/images/faces/6.jpg"></div>
                                                ...
                                                <div class="tab-content main-chat-list flex-2">
                                                    <div class="tab-pane active" id="ChatList">
                                                        <div class="main-chat-list tab-pane">
                                                            ...
                                                            <a class="media new" href="#">
                                                                <div class="main-img-user"><img alt="" src="../assets/images/users/20.jpg"></div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                    ...
                                                    <div class="tab-pane" id="ChatContacts">
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <a href="#" class="d-flex align-items-center media">
                                                                <div class="mb-0 me-2">
                                                                    <div class="main-img-user online">
                                                                        <img alt="" src="../assets/images/users/20.jpg"> <span>2</span>
                                                                    </div>
                                                                </div>
                                                                <div class="align-items-center justify-content-between">
                                                                    <div class="media-body ms-2">
                                                ...
                                                <div class="main-chat-body flex-2" id="ChatBody">
                                                    <div class="content-inner">
                                                        ...
                                                        <div class="media flex-row-reverse chat-right">
                                                            <div class="main-img-user online"><img alt="avatar" src="../assets/images/users/20.jpg"></div>
                                                            <div class="media-body">
                                            ...
                                            <div class="main-content-app">
                                                ...
                                                <div class="text-center chat-image p-4 pb-0 mb-4 br-5">
                                                    <div class="rounded-circle chat-profile">
                                                        <a class="rounded-circle" href="profile.php"><img alt="profile-avatar" src="../assets/images/users/1.jpg" class="avatar avatar-xl rounded-circle"></a>
                                                    </div>
                                                    <div class="main-chat-msg-name">
                                                        <a href="profile.php">
                                                    ...
                                                    <div class="row row-sm chat-media">
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="../assets/images/files/doc.png" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="../assets/images/files/file.png" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="../assets/images/files/image.png" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="../assets/images/files/ppt.png" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="../assets/images/files/word.png" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="../assets/images/files/zip.png" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
