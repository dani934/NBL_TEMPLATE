										...
										<div class="card-body">
											<div class="example">
												<div class="media mt-0">
													<img class="avatar avatar-lg brround me-3 mb-4" src="../assets/images/faces/1.jpg" alt="Generic placeholder image">
								...
								<div class="col-12">
									<div class="card Relatedpost nested-media">
										...
										<div class="card-body">
											<div class="example">
												<div class="media mt-0">
													<img class="avatar avatar-lg rounded-circle me-3 mb-4" src="../assets/images/faces/2.jpg" alt="Generic placeholder image">
													<div class="media-body text-muted">
														<h4 class="mt-0 text-dark">Media heading</h4>
								...
								<div class="col-12">
									<div class="card Relatedpost nested-media overflow-hidden">
										...
										<div class="card-body overflow-hidden">
											<div class="example">
												<div class="media mt-0">
													<img class="avatar avatar-lg brround me-3 mb-4" src="../assets/images/faces/3.jpg" alt="Generic placeholder image">
													<div class="media-body overflow-hidden text-muted">
														...
														<div class="media mt-5">
															<img class="avatar avatar-lg brround me-3 mb-4" src="../assets/images/faces/4.jpg" alt="Generic placeholder image">
															<div class="media-body overflow-hidden text-muted">
																<h4 class="mt-0 text-dark">Media heading</h4>
											...
											<div class="example">
												<ul class="list-unstyled">
													<li class="media mt-0 border-bottom-0">
														<img class="avatar avatar-lg brround me-3 mb-4" src="../assets/images/faces/5.jpg" alt="Generic placeholder image">
														<div class="media-body text-muted">
													...
													<li class="media my-5 border-bottom-0">
														<img class="avatar avatar-lg brround me-3 mb-4" src="../assets/images/faces/6.jpg" alt="Generic placeholder image">
														<div class="media-body text-muted">
													...
													<li class="media border-bottom-0">
														<img class="avatar avatar-lg brround me-3 mb-4" src="../assets/images/faces/7.jpg" alt="Generic placeholder image">
														<div class="media-body text-muted">
										...
										<div class="card-body">
											<div class="example">
												<div class="media mt-0">
													...
													<img class="ms-2 mt-3 mb-3 avatar avatar-lg brround" src="../assets/images/faces/11.jpg" alt="Generic placeholder image">
												</div>
											</div>
										</div>
									</div>
