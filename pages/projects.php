												...
												<div class="card-body project-type-container projects p-4">
													...
													<div class="d-sm-flex align-items-center">
														<div class="btn-list mx-4">
															...
															<a class="btn btn-outline-primary" href="projects-list.php">
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1"> <a href="project-details.php" class="float-start">Web Design</a> <span class="text-muted bg-light fs-11 mx-2">opened yesterday</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-0 text-normal"> <a href="project-details.php" class="float-start">Cloud Computing</a> <span class="text-muted bg-light fs-11  mx-2">opened 1min ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">SQL</a> <span class="text-muted bg-light fs-11 mx-2">opened 1mth ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">Ethical Hacking</a> <span class="text-muted bg-light fs-11 mx-2">opened 3d ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">Login Authentication</a> <span class="text-muted bg-light fs-11 mx-2">opened 1min ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">SEO Using React</a> <span class="text-muted bg-light fs-11 mx-2">opened 4mth ago</span> </h6>
																						<span class="text-muted border-end pe-2 fs-11 float-start mt-1">75 tasks</span>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">System Design</a> <span class="text-muted bg-light fs-11 mx-2">opened 2d ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">Database Administration</a> <span class="text-muted bg-light fs-11 mx-2">opened 3d ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">Web Design</a> <span class="text-muted bg-light fs-11 mx-2">opened yesterday</span> </h6>
																						<span class="text-muted border-end pe-2 fs-11 float-start mt-1">28 tasks</span>
																						<span class="text-teritary ps-1 fs-11">11 Nov 19</span>
																					</div>
																				</div>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">Cloud Computing</a> <span class="text-muted bg-light fs-11 mx-2">opened 1min ago</span> </h6>
																						<span class="text-muted border-end pe-2 fs-11 float-start mt-1">58 tasks</span>
																						<span class="text-teritary ps-1 fs-11">16 Apr 21</span>
																					</div>
																				</div>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="project-details.php" class="float-start">System Design</a> <span class="text-muted bg-light fs-12 mx-2">opened 2d ago</span> </h6>
																						<span class="text-muted border-end pe-2 fs-11 float-start mt-1">116 tasks</span>
																						<span class="text-teritary ps-1 fs-11">11 Nov 21</span>
																					</div>
																				</div>
