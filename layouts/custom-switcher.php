							...
							<div class="predefined_styles">
								<div class="swichermainleft text-center">
									<div class="p-3 d-grid gap-2">
										<a href="https://php.spruko.com/noa/noa/pages/index.php" class="btn ripple btn-primary mt-0">View Demo</a>
										<a href="https://themeforest.net/item/noa-bootstrap-5-admin-dashboard-template/37408518"
