											...
											<div class="text-wrap">
												<div class="example">
													<div class="alert alert-avatar alert-default alert-dismissible">
														...
														<span class="avatar brround cover-image" data-bs-image-src="../assets/images/users/8.jpg"></span>
													...
													<div class="alert alert-avatar alert-info alert-dismissible">
														<button type="button" class="btn-close" data-bs-dismiss="alert" aria-hidden="true">×</button>
														<span class="avatar brround cover-image" data-bs-image-src="../assets/images/users/15.jpg"></span>
														Lorem ipsum dolor sit amet, consectetur adipisicing elit.
													</div>
													<div class="alert alert-avatar alert-warning alert-dismissible">
														<button type="button" class="btn-close" data-bs-dismiss="alert" aria-hidden="true">×</button>
														<span class="avatar brround cover-image" data-bs-image-src="../assets/images/users/7.jpg"></span>
														Lorem ipsum dolor sit amet, consectetur adipisicing elit.
													</div>
													...
													<div class="alert alert-avatar alert-dark alert-dismissible">
														<button type="button" class="btn-close" data-bs-dismiss="alert" aria-hidden="true">×</button>
														<span class="avatar brround cover-image" data-bs-image-src="../assets/images/users/6.jpg"></span>
														Lorem ipsum dolor sit amet, consectetur adipisicing elit.
													</div>
												</div>
											</div>
