																...
																<div class="carousel slide h-100" data-bs-interval="t" id="thumbcarousel">
																	<div class="carousel-inner h-100">
																		<ul class="carousel-item active d-flex h-100">
																			<li class="thumb my-2" data-bs-slide-to="0" data-bs-target="#Slider"><img alt="img" src="../assets/images/pngs/6.png"></li>
																			<li class="thumb my-2" data-bs-slide-to="1" data-bs-target="#Slider"><img alt="img" src="../assets/images/pngs/2.png"></li>
																			<li class="thumb my-2 active" data-bs-slide-to="2" data-bs-target="#Slider"><img alt="img" src="../assets/images/pngs/3.png"></li>
																			<li class="thumb my-2" data-bs-slide-to="3" data-bs-target="#Slider"><img alt="img" src="../assets/images/pngs/4.png"></li>
																			<li class="thumb my-2" data-bs-slide-to="4" data-bs-target="#Slider"><img alt="img" src="../assets/images/pngs/9.png"></li>
																		</ul>
																	</div>
																</div>
															</div>
																...
																<div class="carousel slide h-100" data-bs-ride="false" id="Slider">
																	<div class="carousel-inner h-100">
																		<div class="carousel-item">
																			<img alt="img" class="img-fluid w-100 d-block" src="../assets/images/pngs/6.png">
																		</div>
																		<div class="carousel-item">
																			<img alt="img" class="img-fluid w-100 d-block" src="../assets/images/pngs/2.png">
																		</div>
																		<div class="carousel-item active">
																			<img alt="img" class="img-fluid w-100 d-block" src="../assets/images/pngs/3.png">
																		</div>
																		<div class="carousel-item">
																			<img alt="img" class="img-fluid w-100 d-block" src="../assets/images/pngs/4.png">
																		</div>
																		<div class="carousel-item">
																			<img alt="img" class="img-fluid w-100 d-block" src="../assets/images/pngs/9.png">
																		</div>
																	</div>
																</div>
															</div>
															...
															<div class="row">
																...
																<div class="col-auto d-flex align-items-center">
																	<p class="mb-0 text-muted">
																		...
																		Deliver to Elena Gilbert.<a href="checkout.php" role="button" class="text-teritary ms-2">change</a>
																	</p>
																</div>
															</div>
														</div>
										...
										<div class="col-md-12">
											<div class="card">
												<div class="card-body">
													...
													<form action="index.php" class="form-horizontal m-t-20">
											...
											<div class="card item-card">
												<div class="product-grid6 card-body">
													<div class="product-image6">
														<a href="product-details.php" class="img-container">
															<img class="img-fluid" src="../assets/images/pngs/6.png" alt="img">
														</a>
														<div class="icon-container">
															<ul class="icons">
																<li>
																	<a href="product-details.php" data-tip="Quick View">
																...
																<li>
																	<a href="wishlist.php" data-tip="Add to Wishlist">
																...
																<li>
																	<a href="cart.php" data-tip="Add to Cart">
