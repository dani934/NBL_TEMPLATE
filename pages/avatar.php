											...
											<div class="text-wrap">
												<div class="example">
													<div class="avatar-list indicators">
														<span class="avatar avatar-sm rounded-circle cover-image" data-bs-image-src= "../assets/images/users/4.jpg"></span>
														<span class="avatar avatar-normal rounded-circle cover-image" data-bs-image-src= "../assets/images/users/3.jpg"></span>
														<span class="avatar avatar-md rounded-circle cover-image offline" data-bs-image-src= "../assets/images/users/5.jpg"></span>
														<span class="avatar avatar-lg rounded-circle cover-image" data-bs-image-src= "../assets/images/users/6.jpg"></span>
														<span class="avatar avatar-xl rounded-circle cover-image offline" data-bs-image-src= "../assets/images/users/4.jpg"></span>
														<span class="avatar avatar-xxl rounded-circle cover-image" data-bs-image-src= "../assets/images/users/7.jpg"></span>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="text-wrap">
												<div class="example">
													<div class="avatar-list indicators">
														<span class="avatar avatar-lg brround cover-image" data-bs-image-src="../assets/images/users/12.jpg"></span>
														<span class="avatar avatar-lg cover-image mx-3" data-bs-image-src="../assets/images/users/13.jpg"></span>
														<span class="avatar avatar-lg rounded-circle cover-image" data-bs-image-src= "../assets/images/users/11.jpg"></span>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="text-wrap">
												<div class="example">
													<div class="avatar-list indicators">
														<span class="avatar avatar-xl rounded-circle cover-image  me-2" data-bs-image-src= "../assets/images/users/6.jpg"></span>
														<span class="avatar avatar-xl rounded-circle cover-image  ms-2 offline" data-bs-image-src= "../assets/images/users/12.jpg"></span>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="card-body d-flex row">
										...
										<div class="text-wrap ">
											<div class="example">
												<div class="avatar-list avatar-list-stacked">
													<span class="avatar avatar-lg rounded-circle bradius cover-image" data-bs-image-src= "../assets/images/users/8.jpg"></span>
													<span class="avatar avatar-lg rounded-circle bradius cover-image" data-bs-image-src= "../assets/images/users/7.jpg"></span>
													<span class="avatar avatar-lg rounded-circle bradius cover-image" data-bs-image-src= "../assets/images/users/9.jpg"></span>
													<span class="avatar avatar-lg rounded-circle bradius cover-image" data-bs-image-src= "../assets/images/users/14.jpg"></span>
													<span class="avatar avatar-lg rounded-circle bradius cover-image" data-bs-image-src= "../assets/images/users/11.jpg"></span>
									...
									<div class="col-md-12 col-lg-6 my-1">
										<div class="text-wrap ">
											<div class="example">
												<div class="avatar-list avatar-list-stacked">
													<span class="avatar avatar-lg bradius cover-image" data-bs-image-src= "../assets/images/users/8.jpg"></span>
													<span class="avatar avatar-lg bradius cover-image" data-bs-image-src= "../assets/images/users/7.jpg"></span>
													<span class="avatar avatar-lg bradius cover-image" data-bs-image-src= "../assets/images/users/9.jpg"></span>
													<span class="avatar avatar-lg bradius cover-image" data-bs-image-src= "../assets/images/users/14.jpg"></span>
													<span class="avatar avatar-lg bradius cover-image" data-bs-image-src= "../assets/images/users/11.jpg"></span>
