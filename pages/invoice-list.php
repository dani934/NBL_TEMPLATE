										...
										<div class="card-body p-0">
											...
											<div class="d-flex align-items-center justify-content-between py-5 px-6 mt-2">
												<div>
													...
													<p class="fs-14 mb-0">
														<a href="invoice-details.php" class="text-primary">#INV-1116</a>
													</p>
												</div>
												<div>
											...
											<div class="d-sm-flex align-items-center justify-content-between py-5 px-6">
												<div class="d-flex align-items-center">
													<div class="me-2">
														<img alt="User Avatar" class="rounded-circle avatar-lg" src="../assets/images/users/1.jpg">
													</div>
													<div>
									...
									<div class="card">
										<div class="card-body p-0">
											...
											<div class="d-sm-flex align-items-center justify-content-between py-5 px-6">
												<div class="d-flex align-items-center">
													<div class="me-2">
														<img alt="User Avatar" class="rounded-circle avatar-lg" src="../assets/images/users/12.jpg">
													</div>
													<div>
									...
									<div class="card">
										<div class="card-body p-0">
											...
											<div class="d-sm-flex align-items-center justify-content-between py-5 px-6">
												<div class="d-flex align-items-center">
													<div class="me-2">
														<img alt="User Avatar" class="rounded-circle avatar-lg" src="../assets/images/users/13.jpg">
													</div>
													<div>
									...
									<div class="card">
										<div class="card-body p-0">
											...
											<div class="d-sm-flex align-items-center justify-content-between py-5 px-6">
												<div class="d-flex align-items-center">
													<div class="me-2">
														<img alt="User Avatar" class="rounded-circle avatar-lg" src="../assets/images/users/2.jpg">
													</div>
													<div>
									...
									<div class="card">
										<div class="card-body p-0">
											...
											<div class="d-sm-flex align-items-center justify-content-between py-5 px-6">
												<div class="d-flex align-items-center">
													<div class="me-2">
														<img alt="User Avatar" class="rounded-circle avatar-lg" src="../assets/images/users/15.jpg">
													</div>
													<div>
									...
									<div class="card">
										<div class="card-body p-0">
											...
											<div class="d-sm-flex align-items-center justify-content-between py-5 px-6">
												<div class="d-flex align-items-center">
													<div class="me-2">
														<img alt="User Avatar" class="rounded-circle avatar-lg" src="../assets/images/users/4.jpg">
													</div>
													<div>
									...
									<div class="card">
										<div class="card-body p-0">
											...
											<div class="d-sm-flex align-items-center justify-content-between py-5 px-6">
												<div class="d-flex align-items-center">
													<div class="me-2">
														<img alt="User Avatar" class="rounded-circle avatar-lg" src="../assets/images/users/16.jpg">
													</div>
													<div>
									...
									<div class="card">
										<div class="card-body p-0">
											...
											<div class="d-sm-flex align-items-center justify-content-between py-5 px-6">
												<div class="d-flex align-items-center">
													<div class="me-2">
														<img alt="User Avatar" class="rounded-circle avatar-lg" src="../assets/images/users/3.jpg">
													</div>
													<div>
														<h6 class="mb-1">Lisbon Taylor</h6>
														<span class="text-muted fs-13">invoice@spruko.com</span>
