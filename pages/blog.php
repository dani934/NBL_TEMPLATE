							...
							<div class="row">
								<div class="col-xl-8 col-lg-7 col-md-12">
									<div class="card overflow-hidden">
										<a href="blog-details.php" class="card custom-card background-image-blog img1 mb-0">
										...
										<div class="card-body">
											...
											<a href="blog-details.php" class="btn btn-outline-primary mt-2">Read More</a>
										</div>
											...
											<div class="row">
												<div class="col-xl-6 col-md-12 my-2 p-xl-max-0">
													<div class="card overflow-hidden box-shadow mb-0 main-blog">
														<a href="blog-details.php" class="background-image-blog img2 mb-0">
											...
											<div class="row">
												<div class="col-xl-6 col-md-12">
													<div class="card overflow-hidden box-shadow mb-0 main-blog my-xl-0 my-2">
														<a href="blog-details.php" class="background-image-blog img3 mb-0">
												...
												<div class="col-xl-6 col-md-12">
													<div class="card overflow-hidden box-shadow mb-0 main-blog">
														<a href="blog-details.php" class="background-image-blog img4 mb-0">
