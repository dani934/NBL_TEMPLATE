							...
							<div class="row">
								<div class="col-md-12 col-xl-4">
									<div class="card ">
										...
										<div class="card-body text-center">
											<span class="avatar avatar-xxl brround cover-image cover-image" data-bs-image-src="../assets/images/users/18.jpg"></span>
								...
								<div class="col-md-12 col-xl-4">
									<div class="card ">
										...
										<div class="card-body text-center">
											<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="../assets/images/users/8.jpg"></span>
										...
										<div class="card-body">
											<div class="visitor-list">
												...
												<div class="media mt-2 border-bottom">
													<img class="avatar brround avatar-md me-3" alt="avatra-img" src="../assets/images/users/20.jpg">
													<div class="media-body">
