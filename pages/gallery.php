							...
							<div class="demo-gallery card">
								...
								<div class="card-body">
									<ul id="lightgallery" class="list-unstyled row">
										...
										<li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 mb-xl-0 border-bottom-0" data-responsive="../assets/images/media/12.jpg" data-src="../assets/images/media/12.jpg" data-sub-html="<h4>Gallery Image 12</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
											<a href="javascript:void(0)">
