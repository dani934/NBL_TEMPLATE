						...
						<div class="main-container container-fluid">
							...
							<div class="page-header">
								...
								<div class="ms-auto pageheader-btn">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Footers</li>
									</ol>
								</div>
							</div>
							<!-- PAGE-HEADER END -->
								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-header">
											<h3 class="card-title">Default Footer</h3>
										</div>
										<div class="footer">
											<div class="container">
								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-header border-bottom">
											<h3 class="card-title">Footer style01</h3>
										</div>
										<div class="footer border-top-0 footer-1">
											<div class="container">
												<div class="row align-items-center icons-bg">
													<div class="social">
													...
													<div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
														Copyright © 2022 <a href="#">Noa</a>. Designed by <a href="#">Spruko</a> All rights reserved.
													</div>
												</div>
											</div>
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="card">
										<div class="card-header border-bottom">
											<h3 class="card-title">Footer style02</h3>
										</div>
										<div class="footer border-top-0 footer-1">
											<div class="container">
												<div class="row align-items-center">
													<div class="col-lg-6 col-sm-12  col-md-5 mt-3 mt-lg-0 text-center d-none d-md-block icons-bg">
														<div class="social">
															<ul class="text-center">
																<li>
																	<a class="social-icon" href="javascript:void(0)"><i class="fa fa-facebook"></i></a>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="card">
										<div class="card-header border-bottom">
											<h3 class="card-title">Footer style03</h3>
										</div>
										<div class="footer border-top-0 footer-1">
											<div class="container">
												<div class="row align-items-center text-center">
													<div class="col-lg-6 col-md-6 d-none d-md-block icons-bg">
														<div class="social">
													...
													<div class="col-lg-6 col-md-6 text-end privacy">
														<a href="#" class="btn btn-link shadow-none" >Privacy</a>
														<a href="#" class="btn btn-link shadow-none" >Terms</a>
														<a href="#" class="btn btn-link shadow-none" >About Us</a>
													</div>
												</div>
												<div class="row align-items-center flex-row-reverse">
													<div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="card">
										<div class="card-header border-bottom">
											<h3 class="card-title">Footer style04</h3>
										</div>
										<div class="footer border-top-0 footer-1">
											<div class="container">
												<div class="row align-items-center flex-row-reverse">
							...
							<div class="row">
								<div class="col-12">
									<div class="card">
										<div class="card-header border-bottom">
											<h3 class="card-title">Footer style05</h3>
										</div>
										<div class="card-body">
											...
											<footer class="main-footer ps-3 pe-3">
												<div class="row">
													<div class="col-xl-8 col-lg-12 col-md-12 footer1">
														Copyright ©Noa 2022. Design By<a href="https://spruko.com/"> Spruko</a>
													</div>
													<div class="col-xl-4 col-lg-12 col-md-12 ms-auto text-end">
														<ul class="footer-social-list">
															<li><a href="javascript:;" class="social-icon"><i class="fa fa-facebook"></i></a></li>
															<li><a href="javascript:;" class="social-icon"><i class="fa fa-google"></i></a></li>
															<li><a href="javascript:;" class="social-icon"><i class="fa fa-twitter"></i></a></li>
															<li><a href="javascript:;" class="social-icon"><i class="fa fa-linkedin"></i></a></li>
														</ul>
													</div>
												</div>
											</footer>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="card">
										<div class="card-header border-bottom">
											<h3 class="card-title">Footer style06</h3>
										</div>
										<div class="card-body">
											<div class="top-footer">
												<div class="row">
													...
													<div class="col-lg-4 col-md-12">
														...
														<hr>
														<h6 class="mb-0 m-t-30">Payments</h6>
														<ul class="footer-payments">
															<li><a href="javascript:;"><i class="fa fa-cc-amex text-muted" aria-hidden="true"></i></a></li>
