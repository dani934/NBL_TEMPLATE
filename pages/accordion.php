														...
														<div class="border p-3 br-bottom-radius-5">
															<div class="row">
																<div class="col-lg-3 col-md-6">
																	<img class="img-fluid br-5 my-1 my-sm-2" src="../assets/images/photos/8.jpg " alt="banner image">
																</div>
																<div class="col-lg-3 col-md-6">
																	<img class="img-fluid br-5 my-1 my-sm-2" src="../assets/images/photos/10.jpg" alt="banner image ">
																</div>
																<div class="col-lg-3 col-md-6">
																	<img class="img-fluid br-5 my-1 my-sm-2" src="../assets/images/photos/8.jpg" alt="banner image ">
																</div>
																<div class="col-lg-3 col-md-6">
																	<img class="img-fluid br-5 my-1 my-sm-2" src="../assets/images/photos/12.jpg" alt="banner image ">
																</div>
															</div>
														</div>
													</div>
