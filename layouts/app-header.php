                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex main-header-notification flag-dropdown">
                                            <a href="javascript:void(0);" class="nav-link icon text-center country-nav-link" data-bs-target="#country-selector" data-bs-toggle="modal">
												...
												<div class="px-2 pb-4 pt-2">
													<div class="row mb-2">
														<div class="col d-flex">
															<a href="maps1.php" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex p-0">
															<a href="calendar2.php" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex">
															<a href="mail-inbox.php" class="dropdown-menu-item text-muted source-logo-container">
													...
													<div class="row mb-2">
														<div class="col d-flex">
															<a href="chat.php" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex p-0">
															<a href="file-manager.php" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex">
															<a href="products.php" class="dropdown-menu-item text-muted source-logo-container">
													...
													<div class="row">
														...
														<div class="col d-flex p-0">
															<a href="blog.php" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex">
															<a href="form-elements.php" class="dropdown-menu-item text-muted source-logo-container">
                                        ...
                                        <div class="dropdown  d-flex shopping-cart">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                                    <a class="dropdown-item d-flex p-4" href="cart.php">
                                        ...
                                        <div class="dropdown d-md-flex notifications">
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
												...
												<div class="notifications-menu ps3 overflow-hidden">
													...
													<a class="dropdown-item" href="mail-inbox.php">
														<div class="notification-each d-flex">
													...
													<a class="dropdown-item" href="blog-details.php">
														<div class="notification-each d-flex">
