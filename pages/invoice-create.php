									...
									<div  class="card">
										...
										<div class="card-body p-0 invoice-create-main">
												...
												<div class="col-sm-12 col-md-12 col-xl">
													<div class="form-group">
														...
														<div class="input-group">
															...
															<input type="text" id="inv-number" class="form-control text-dark" placeholder="Enter Invoice Number" value="773">
														</div>
													</div>
												</div>
												<div class="col-sm-12 col-md-12 col-xl">
													<div class="form-group">
														...
														<div id="inv-datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
															...
															<input id="invoice-date" class="form-control" type="text" placeholder="DD/MM/YYYY"/>
														</div>
													</div>
												</div>
												<div class="col-sm-12 col-md-12 col-xl">
														...
														<div class="table-responsive product-description-each mb-3">
															<table class="invoice-product-table">
																...
																<tbody class="border">
																	<tr class="dashed-border-bottom">
																		...
																		<td class="w-10">
																			<div class="form-group mb-0">
																				<select class="form-control select2-show-search form-select select2-hidden-accessible" id="currency-type2" data-placeholder="Choose Type..." tabindex="-1" aria-hidden="true">
																					<option label="Choose one"></option>
																					<option value="empty" selected>---</option>
																	...
																	<tr>
																		<td colspan="4">
																			<textarea name="product-description" class="form-control border-0 p-0 px-1" id="productDescription" placeholder="Write Description(Optional)" cols="30" rows="5"></textarea>
																		</td>
																	</tr>
																</tbody>
															</table>
											...
											<div class="row pt-0 pb-5 px-5 border-bottom">
												<div class="col-xl-12">
													<div class="table-responsive invoice-bottom-table-container">
														<table class="table ms-auto invoice-table-bottom w-50 text-end">
															<tbody>
																<tr>
