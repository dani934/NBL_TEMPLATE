...
<html lang="en" dir="ltr">
	...
	<body class="ltr app sidebar-mini light-mode">
												...
												<div class="col-sm-12 col-md-12 col-xl">
													<div class="form-group">
														...
														<div id="inv-datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
															...
															<input id="invoice-date" class="form-control" type="text" placeholder="Select Invoice Date"/>
														</div>
													</div>
												</div>
												<div class="col-sm-12 col-md-12 col-xl">
													<div class="form-group">
														...
														<div id="due-datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
															<span class="input-group-addon input-group-text bg-primary-transparent"><i class="fe fe-calendar text-primary-dark"></i></span>
															<input id="invoice-date1" class="form-control" type="text" placeholder="Select Due Date"/>
														</div>
													</div>
												</div>
												<div class="col-sm-12 col-md-12 col-xl">
													<div class="form-group">
														<label for="currency-type" class="form-label text-muted">Currency:</label>
														<select class="form-control select2-show-search form-select select2-hidden-accessible text-dark" id="currency-type" data-placeholder="Choose Type..." tabindex="-1" aria-hidden="true">
															...
															<option value="day" selected>USD($)</option>
											...
											<div class="row p-5 border-bottom">
												...
												<div class="col-sm-12 col-md col-xl">
													<div class="form-group">
														...
														<select class="form-control select2-show-search form-select select2-hidden-accessible text-dark" id="add-tax" data-placeholder="Choose Type..." tabindex="-1" aria-hidden="true">
															<option label="Choose one"></option>
												...
												<div class="col-xl-12">
													<div class="row">
														<div class="col-xl-6 col-md-6 col-sm-12">
															<div class="form-group">
																<label class="form-label text-muted mb-2 text-dark">Billing Address:</label>
																<p class="text-dark">Street, Line<br>
																	State, City<br>
														...
														<div class="col-xl-6 col-md-6 col-sm-12">
															<div class="form-group">
																...
																<textarea name="shipping-address" class="form-control w-60 mb-2 text-dark" placeholder="Enter Address" id="shipping-address" cols="30" rows="5">11-16/143, Magny Street, US, 12398</textarea>
																<a href="javascript:void(0)" role="button" class="text-primary text-center d-none" id="addShippingAddress">
												...
												<div class="col-xl-12">
													<div class="select-product-container">
														<div class="form-group wp-30">
															<label for="currency-type1" class="form-label text-muted">Product:</label>
															<select class="form-control select2-show-search form-select select2-hidden-accessible" id="currency-type1" data-placeholder="Select Product.." tabindex="-1" aria-hidden="true">
															...
															<table class="invoice-product-table">
																...
																<tbody class="border">
																	<tr class="dashed-border-bottom">
																		<td>
																			<input type="text" class="form-control" placeholder="Item Name" value="Noa Dashboard UI">
																		</td>
																		<td class="w-10">
																			<input type="number" class="form-control" placeholder="Quantity" value="1" min="0">
																		</td>
																		<td class="w-10">
																			<input type="number" class="form-control" placeholder="Price" value="1116" min="0">
																		</td>
																		<td class="w-10">
																		...
																		<td rowspan="2" class="bg-primary-transparent w-15 amount-cell">1773.00</td>
																	</tr>
																	<tr>
																		<td colspan="4">
		...
		<!-- INVOICE EDIT JS-->
		<script src="../assets/js/invoice-edit.js"></script>
