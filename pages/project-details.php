							...
							<div class="row">
								<div class="col-md-12">
									<div class="btn-list text-end mb-3">
										...
										<a href="project-edit.php" class="btn btn-outline-primary me-2">Edit</a>
										<a href="project-new.php" class="btn btn-outline-primary me-2">New</a>
													...
													<div class="row">
														...
														<div class="col-xl-12 mt-2 text-end">
															<div class="btn-list">
																...
																<a href="project-edit.php" class="btn btn-outline-primary">Edit More</a>
															</div>
														</div>
													</div>
												</div>
																...
																<div class="col-xl-3 col-lg-12">
																	<div class="d-f-ai-c-jc-c flex-column border py-5 br-5 details">
																		...
																		<div class="media mt-3 d-flex align-items-center">
																			<img class="avatar-sm rounded-circle me-3 my-auto" src="../assets/images/faces/11.jpg" alt="Image description">
																	...
																	<tbody class="table-body">
																		<tr>
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<img alt="User Avatar" class="rounded-circle avatar-md d-md-none-max" src="../assets/images/users/1.jpg">
																					</div>
																					<div>
																		...
																		<tr>
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<img alt="User Avatar" class="rounded-circle avatar-md d-md-none-max" src="../assets/images/users/12.jpg">
																					</div>
																					<div>
																		...
																		<tr>
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<img alt="User Avatar" class="rounded-circle avatar-md d-md-none-max" src="../assets/images/users/13.jpg">
																					</div>
																					<div>
																		...
																		<tr>
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<img alt="User Avatar" class="rounded-circle avatar-md d-md-none-max" src="../assets/images/users/4.jpg">
																					</div>
																					<div>
																		...
																		<tr>
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<img alt="User Avatar" class="rounded-circle avatar-md d-md-none-max" src="../assets/images/users/5.jpg">
																					</div>
																					<div>
													...
													<div class="card">
														...
														<div class="card-body pb-0">
															<div class="media border br-5 p-4 mb-5 overflow-visible">
																<div class="me-3">
																	<a href="javascript:void(0)"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/5.jpg"> </a>
																</div>
																<div class="media-body overflow-visible">
																	<div class="br-5">
																		...
																		<div class="media mt-5 border br-5 p-4 overflow-visible d-sm-flex d-block">
																			<div class="me-3">
																				<a href="javascript:void(0)"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/2.jpg"> </a>
																			</div>
															...
															<div class="media border br-5 p-4 mb-5 overflow-visible">
																<div class="me-3">
																	<a href="javascript:void(0)"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/12.jpg"> </a>
																</div>
																<div class="media-body overflow-visible">
																	<div class="br-5">
																		<nav class="nav float-end">
																	...
																	<tbody class="table-body">
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<span class="data-image avatar avatar-md rounded-circle" style="background-image: url(../assets/images/users/2.jpg)"></span>
																					</div>
																					<div>
																						<h6 class="mb-0">Skyler Hilda</h6>
																						<span class="text-muted fs-12">member@spruko.com</span>
																			...
																			<td class="fs-15 fw-semibold"><a href="project-details.php" class="text-dark">Noa Dashboard UI</a></td>
																		...
																		<tr>
																			...
																			<td class="text-muted fs-15 fw-semibold"><a href="project-details.php" class="text-dark">Noa Dashboard UI</a></td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<span class="data-image avatar avatar-md rounded-circle" style="background-image: url(../assets/images/users/14.jpg)"></span>
																					</div>
																					<div>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<span class="data-image avatar avatar-md rounded-circle" style="background-image: url(../assets/images/users/15.jpg)"></span>
																					</div>
																					<div>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<span class="data-image avatar avatar-md rounded-circle" style="background-image: url(../assets/images/users/1.jpg)"></span>
																					</div>
																					<div>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<span class="data-image avatar avatar-md rounded-circle" style="background-image: url(../assets/images/users/6.jpg)"></span>
																					</div>
																					<div>
																...
																<table id="tickets-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom project-tickets-main">
																	...
																	<tbody class="table-body">
																		<tr>
																			...
																			<td class="text-muted fs-15 fw-semibold"><a href="ticket-details.php" class="text-dark">Aliquyam sit ea vero et elitr.</a></td>
																		...
																		<tr>
																			...
																			<td class="text-muted fs-15 fw-semibold"><a href="ticket-details.php" class="text-dark">Lorem gubergren est consetetur lorem erat lorem lorem.</a></td>
																			<td class="text-muted fs-15 fw-semibold">Jessica Rose</td>
																			<td class="text-muted fs-15 fw-semibold">General Support</td>
																			<td>
																				<div class="d-flex align-items-center">
																		...
																		<tr>
																			...
																			<td class="text-muted fs-15 fw-semibold"><a href="ticket-details.php" class="text-dark">Voluptua sit sit est erat elitr.</a></td>
																			<td class="text-muted fs-15 fw-semibold">Jessica Rose</td>
																			<td class="text-muted fs-15 fw-semibold">General Support</td>
																			<td>
																				<div class="d-flex align-items-center">
																		...
																		<tr>
																			...
																			<td class="text-muted fs-15 fw-semibold"><a href="ticket-details.php" class="text-dark">Sed et magna ipsum at eirmod et.</a></td>
																		...
																		<tr>
																			<td class="text-muted fs-15 fw-semibold">#TCKT1116</td>
																			<td class="text-muted fs-15 fw-semibold"><a href="ticket-details.php" class="text-dark">Et sed est erat et magna, gubergren.</a></td>
																		...
																		<tr>
																			<td class="text-muted fs-15 fw-semibold">#TCKT1116</td>
																			<td class="text-muted fs-15 fw-semibold"><a href="ticket-details.php" class="text-dark">Et kasd amet aliquyam stet labore.</a></td>
																			<td class="text-muted fs-15 fw-semibold">Lisbon Murillo</td>
																			<td class="text-muted fs-15 fw-semibold">General Support</td>
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
																						<span class="data-image avatar avatar-md rounded-circle" style="background-image: url(../assets/images/users/7.jpg)"></span>
																					</div>
																					<div>
											...
											<div class="row">
												<div class="col-md-12 mb-5">
													<div class="btn-list">
														...
														<a href="invoice-timelog.php" class="btn btn-primary">
															<i class="fe fe-plus-circle"></i>
															Time Log Invoice
														</a>
													</div>
														...
														<div class="card-body billing-table-container">
															<div class="table-responsive">
																<table id="billing-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom project-timetracking-main">
																	...
																	<tbody class="table-body">
																		<tr>
																			<td class="fs-15 fw-semibold"><a href="invoice-details.php" class="text-dark">#INV-1116</a></td>
																			<td class="fs-15 fw-semibold"><a href="project-details.php" class="text-dark">Noa Dashboard UI</a></td>
																			<td>
																				<div class="d-flex align-items-center">
																					<div class="me-2">
									...
									<div class="row">
										<div class="mt-5">
											<div class="media mb-5 overflow-visible">
												<div class="me-3">
													<a href="profile.php"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/5.jpg"> </a>
												</div>
												<div class="media-body overflow-visible">
													...
													<div class="media mb-5 overflow-visible">
														<div class="me-3">
															<a href="profile.php"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/2.jpg"> </a>
														</div>
